...
下载方式请见：iTransformer项目[https://drive.google.com/file/d/1l51QsKvQPcqILT3DwfjCgx8Dsg2rpjot/view]
请下载后放到工作区的datasets/目录下，并利用unzip解压缩，得到datasets/iTransformer_datasets目录，存放所有数据集。
