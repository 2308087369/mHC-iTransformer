from models.layers.DUET_layers import Linear_extractor_cluster, Mahalanobis_mask, Encoder, EncoderLayer, FullAttention, AttentionLayer
...
class DUETModel(nn.Module):
    ...
    def forward(self, input, masks=None, is_training=True):
        ...
        # Modify return to match other models (output only) or handle extra return in main.py
        # TimeFilter returns (outputs, aux_loss). DUET returns (output, L_importance).
        # So I can return both.
        return output, L_importance
